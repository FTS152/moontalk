...
class Chat extends CI_Controller {
    ...
    public function room()
    {
        ...
        $data['socket_url'] = "ws://192.168.2.62:9000/web_socket/Chat-Using-WebSocket-and-PHP-Socket-master/CI_talk/php_websocket_chatroom/server.php";//socket server 路徑指向
